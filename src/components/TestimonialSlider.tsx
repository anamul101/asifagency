    ...
    <section className="py-16 md:py-24 bg-black text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative z-10">
          <div className="select-none flex items-center justify-center pointer-events-none absolute -top-[60%] -left-[10%] -right-[10%] bottom-[20%] opacity-50"></div>

          <div ref={sliderRef} className="keen-slider flex items-center justify-center lg:max-w-[1096px] relative overflow-hidden bg-[#0A0B0D] to-transparent border border-[#e5e7eb37] rounded-[16px] ">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="keen-slider__slide flex items-center justify-center min-w-full px-6 py-10 md:py-20"
              >
